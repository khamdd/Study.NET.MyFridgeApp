...
namespace MyFridgeApp.Services
{
    ...
    internal static class ItemService
    {
        ...
        /// </summary>
        public static async Task<List<Item>> GetAllAsync(bool includeDeleted = false)
        {
        ...
        /// </summary>
        public static async Task<Item?> GetByIdAsync(int id)
        {
            using var db = new Context();
        ...
        /// </summary>
        public static async Task<List<Item>> GetExpiringSoonAsync(int days)
        {
        ...
        /// </summary>
        public static async Task<bool> UpdateAsync(Item item)
        {
            using var db = new Context();
        ...
        /// </summary>
        public static async Task<bool> SoftDeleteAsync(int id)
        {
            using var db = new Context();
        ...
        /// </summary>
        public static async Task<int?> GetCategoryIdByNameAsync(string name)
        {
